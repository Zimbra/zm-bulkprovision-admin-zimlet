...
function ZaBulkDataImportXWizard(parent, entry) {
    ...
    this.stepChoices = [ {
        ...
        label : com_zimbra_bulkprovision.DataImport_Wizard_Options,
        value : ZaBulkDataImportXWizard.STEP_OPTIONS
    }, {
        label : com_zimbra_bulkprovision.DataImport_File_Upload,
        value : ZaBulkDataImportXWizard.STEP_FILE_UPLOAD
    }, {
        label : com_zimbra_bulkprovision.DataImport_Wizard_AcctPicker,
        value : ZaBulkDataImportXWizard.STEP_ACCT_PICKER
    }, {
        label : com_zimbra_bulkprovision.DataImport_IMAP_Info,
        value : ZaBulkDataImportXWizard.STEP_IMAP_OPTIONS
    }, {
        label : com_zimbra_bulkprovision.DataImport_Review,
        value : ZaBulkDataImportXWizard.STEP_REVIEW
    }, {
        label : com_zimbra_bulkprovision.DataImport_Finish,
        value : ZaBulkDataImportXWizard.STEP_FINISH
    } ];
 ...
 *            object to display
 */
ZaBulkDataImportXWizard.prototype.setObject = function(entry) {
    ...
    /*
     * if(this._containedObject[ZaBulkProvision.A2_sourceServerType] ==
     * ZaBulkProvision.MAIL_SOURCE_TYPE_EXCHANGE_IMAP &&
     * !this._containedObject[ZaBulkProvision.A_aid]) {
     * this._containedObject[ZaBulkProvision.A2_sourceType] =
     * ZaBulkProvision.SOURCE_TYPE_XML;
    ...
    // ZaBulkDataImportXWizard.STEP_INTRODUCTION;
 ...
 */
ZaBulkDataImportXWizard.prototype.setUploadManager = function(uploadManager) {
...
ZaBulkDataImportXWizard.prototype.goNext = function() {
    ...
    if (cStep == ZaBulkDataImportXWizard.STEP_OPTIONS
            ...
            && (this._containedObject[ZaBulkProvision.A2_sourceServerType] == ZaBulkProvision.MAIL_SOURCE_TYPE_IMAP
                    || this._containedObject[ZaBulkProvision.A2_sourceServerType] == ZaBulkProvision.MAIL_SOURCE_TYPE_EXCHANGE_IMAP || this._containedObject[ZaBulkProvision.A2_sourceServerType] == ZaBulkProvision.MAIL_SOURCE_TYPE_ZIMBRA)) {
        this.goPage(ZaBulkDataImportXWizard.STEP_FILE_UPLOAD);
        this._button[DwtWizardDialog.FINISH_BUTTON].setEnabled(false);
        this._button[DwtWizardDialog.NEXT_BUTTON].setEnabled(true);
        this._button[DwtWizardDialog.PREV_BUTTON].setEnabled(true);
        ...
        var prevCallback = new AjxCallback(this._app.getCurrentController(), ZaBulkProvisionTasksController.prototype.bulkDataImportListener, [ "migrationWizard" ]);
        ZaBulkProvisionTasksController.prototype.openMigrationWizard.call(this._app.getCurrentController(), {
            prevCallback : prevCallback,
            hideWiz : "bulkDataImportWizard"
        }, null);
    } else if (cStep == ZaBulkDataImportXWizard.STEP_INTRODUCTION
            && (this._containedObject[ZaBulkProvision.A2_sourceServerType] == ZaBulkProvision.MAIL_SOURCE_TYPE_IMAP || this._containedObject[ZaBulkProvision.A2_sourceServerType] == ZaBulkProvision.MAIL_SOURCE_TYPE_EXCHANGE_IMAP)
        ...
        var finishCallback = new AjxCallback(this._app.getCurrentController(), ZaBulkProvisionTasksController.prototype.bulkDataImportListener, [ "importAccountsWizard", auxObj1 ]);
        ...
        var prevCallback = new AjxCallback(this._app.getCurrentController(), ZaBulkProvisionTasksController.prototype.bulkDataImportListener, [ "importAccountsWizard", auxObj2 ]);
        ...
        ZaBulkProvisionTasksController.prototype.openBulkProvisionDialog.call(this._app.getCurrentController(), {
            ...
            && (this._containedObject[ZaBulkProvision.A2_sourceServerType] == ZaBulkProvision.MAIL_SOURCE_TYPE_IMAP
                    || this._containedObject[ZaBulkProvision.A2_sourceServerType] == ZaBulkProvision.MAIL_SOURCE_TYPE_ZIMBRA || this._containedObject[ZaBulkProvision.A2_sourceServerType] == ZaBulkProvision.MAIL_SOURCE_TYPE_EXCHANGE_IMAP)
        ...
        // generate a preview of options, skip STEP_IMAP_OPTIONS, because these
        // options should be in the XML
 ...
 */
ZaBulkDataImportXWizard.fwdPoolButtonHndlr = function(evt) {
 ...
 * method of an XFormItem
 */
ZaBulkDataImportXWizard.backPoolButtonHndlr = function(evt) {
...
ZaBulkDataImportXWizard.forwardBtnEnabled = function() {
    return (parseInt(this.getInstanceValue(ZaBulkProvision.A2_poolPagenum)) < (parseInt(this.getInstanceValue(ZaBulkProvision.A2_poolNumPages)) - 1) && this
            .getInstanceValue(ZaBulkProvision.A2_activateSearch) == 1);
};
...
ZaBulkDataImportXWizard.myXFormModifier = function(xFormObject, entry) {
    ...
    var case_intro = {
        ...
        tabGroupKey : ZaBulkDataImportXWizard.STEP_OPTIONS,
        caseKey : ZaBulkDataImportXWizard.STEP_INTRODUCTION,
        items : [ {
            type : _DWT_ALERT_,
            colSpan : 2,
            style : DwtAlert.INFO,
            iconVisible : false,
            content : com_zimbra_bulkprovision.DataImportWizardOverview,
            visibilityChecks : []
        }, {
            ref : ZaBulkProvision.A2_sourceServerType,
            type : _OSELECT1_,
            label : com_zimbra_bulkprovision.SourceServerType,
            labelLocation : _LEFT_,
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            type : _OSELECT1_,
            label : com_zimbra_bulkprovision.ImportAccountRecordsQ,
            ...
            type : _OSELECT1_,
            label : com_zimbra_bulkprovision.ImportAccountMailQ,
            ref : ZaBulkProvision.A2_importEmail,
            choices : this.yesNoChoices,
            visibilityChecks : [],
            enableDisableChecks : []
        } ]
    ...
    var case_options = {
        ...
        colSizes : [ "250px", "380px" ],
        tabGroupKey : ZaBulkDataImportXWizard.STEP_OPTIONS,
        caseKey : ZaBulkDataImportXWizard.STEP_OPTIONS,
        items : [ {
            type : _DWT_ALERT_,
            colSpan : 2,
            style : DwtAlert.INFO,
            iconVisible : false,
            content : com_zimbra_bulkprovision.AccountListTypeNote,
            visibilityChecks : []
        }, {
            type : _RADIO_,
            groupname : "source_selection_group",
            ref : ZaBulkProvision.A2_sourceType,
            bmolsnr : true,
            labelLocation : _RIGHT_,
            label : com_zimbra_bulkprovision.PickAccounts,
            ...
            visibilityChecks : [ [ XForm.checkInstanceValueNot, ZaBulkProvision.A2_sourceServerType, ZaBulkProvision.MAIL_SOURCE_TYPE_EXCHANGE_IMAP ] ],
            enableDisableChecks : []
        }, {
            type : _RADIO_,
            groupname : "source_selection_group",
            ...
            bmolsnr : true,
            labelLocation : _RIGHT_,
            label : com_zimbra_bulkprovision.UploadAccountsInXML,
            updateElement : function(newValue) {
            ...
            bmolsnr : true,
            labelLocation : _RIGHT_,
            label : com_zimbra_bulkprovision.ReuseAccountsXML,
            updateElement : function(newValue) {
            ...
            visibilityChecks : [ [ XForm.checkInstanceValueNotEmty, ZaBulkProvision.A_aid ] ],
            enableDisableChecks : [],
            visibilityChangeEventSources : [ ZaBulkProvision.A_aid ]
        } ]
    };
    ...
    var case_file_upload = {
        ...
        numCols : 2,
        colSizes : [ "250px", "380px" ],
        tabGroupKey : ZaBulkDataImportXWizard.STEP_FILE_UPLOAD,
        caseKey : ZaBulkDataImportXWizard.STEP_FILE_UPLOAD,
        items : [ {
            type : _OUTPUT_,
            value : ZaBulkDataImportXWizard.getUploadFormHtml(),
            colSpan : 2
        } ]
    };
    ...
    var case_acct_picker = {
        type : _CASE_,
        caseKey : ZaBulkDataImportXWizard.STEP_ACCT_PICKER,
        tabGroupKey : ZaBulkDataImportXWizard.STEP_ACCT_PICKER,
        numCols : 2,
        colSizes : [ "250px", "380px" ],
        items : [ {
            type : _GROUP_,
            ...
            items : [ {
                ...
                width : "80px",
                onActivate : ZaBulkDataImportXWizard.srchButtonHndlr,
                align : _CENTER_,
                ...
                type : _OUTPUT_,
                value : com_zimbra_bulkprovision.AccountsForDataImport,
                visibilityChecks : []
            }, {
                ref : ZaBulkProvision.A2_accountPool,
                type : _DWT_LIST_,
                height : "200px",
                width : "170px",
                cssClass : "DLSource",
                ...
                ref : ZaBulkProvision.A2_account,
                type : _DWT_LIST_,
                height : "200px",
                width : "170px",
                cssClass : "DLSource",
                ...
                label : AjxMsg.add,
                width : "80px",
                onActivate : ZaBulkDataImportXWizard.addButtonHndlr,
                bmolsnr : true,
                ...
                label : AjxMsg.remove,
                width : "80px",
                onActivate : ZaBulkDataImportXWizard.removeButtonHndlr,
                bmolsnr : true,
                ...
                items : [ {
                    ...
                    onActivate : ZaBulkDataImportXWizard.backPoolButtonHndlr,
                    align : _CENTER_,
                    ...
                    onActivate : ZaBulkDataImportXWizard.fwdPoolButtonHndlr,
                    align : _CENTER_,
                ...
                iconVisible : true,
                content : ZaMsg.pleaseWaitSearching,
                width : "200px",
                align : _CENTER_,
                cssStyle : "position:relative;top:-200;left:125;opacity: 0.8",
    ...
    var case_imap_options = {
        type : _CASE_,
        numCols : 2,
        colSizes : [ "250px", "380px" ],
        tablGroupKey : ZaBulkDataImportXWizard.STEP_IMAP_OPTIONS,
        caseKey : ZaBulkDataImportXWizard.STEP_IMAP_OPTIONS,
        items : [ {
            ref : ZaBulkProvision.A2_connectionType,
            type : _OSELECT1_,
            label : com_zimbra_bulkprovision.IMAPConnectionType,
            labelLocation : _LEFT_,
            visibilityChecks : [],
            enableDisableChecks : [],
            elementChanged : function(elementValue, instanceValue, event) {
            ...
            type : _TEXTFIELD_,
            label : com_zimbra_bulkprovision.IMAPHost,
            ref : ZaBulkProvision.A2_IMAPHost,
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            type : _TEXTFIELD_,
            label : com_zimbra_bulkprovision.IMAPPort,
            ref : ZaBulkProvision.A2_IMAPPort,
            visibilityChecks : [],
            enableDisableChecks : [],
            bmolsnr : true
        }, {
            ref : ZaBulkProvision.A2_useAdminLogin,
            type : _CHECKBOX_,
            label : com_zimbra_bulkprovision.UseIMAPAdminCredentialsChkBx,
            trueValue : "1",
            falseValue : "0",
            visibilityChecks : [],
            enableDisableChecks : []
            ...
            type : _TEXTFIELD_,
            label : com_zimbra_bulkprovision.IMAPAdminLogin,
            ref : ZaBulkProvision.A2_IMAPAdminLogin,
            ...
            type : _SECRET_,
            label : com_zimbra_bulkprovision.IMAPAdminPassword,
            ref : ZaBulkProvision.A2_IMAPAdminPassword,
            enableDisableChecks : [ [ XForm.checkInstanceValue, ZaBulkProvision.A2_useAdminLogin, "1" ] ],
            enableDisableChangeEventSources : [ ZaBulkProvision.A2_useAdminLogin ],
            visibilityChecks : []
        }, {
            type : _SECRET_,
            label : com_zimbra_bulkprovision.IMAPAdminPasswordConfirm,
            ref : ZaBulkProvision.A2_IMAPAdminPasswordConfirm,
            enableDisableChecks : [ [ XForm.checkInstanceValue, ZaBulkProvision.A2_useAdminLogin, "1" ] ],
            enableDisableChangeEventSources : [ ZaBulkProvision.A2_useAdminLogin ],
            visibilityChecks : []
        } ]
    ...
    var case_review = {
        ...
        numCols : 2,
        colSizes : [ "250px", "380px" ],
        tablGroupKey : ZaBulkDataImportXWizard.STEP_REVIEW,
        caseKey : ZaBulkDataImportXWizard.STEP_REVIEW,
        items : [ {
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.TotalMailboxes,
        ...
        {
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.RunningMailboxes,
            ref : ZaBulkProvision.A2_runningCount,
            visibilityChecks : [ [ XForm.checkInstanceValueNotEmty, ZaBulkProvision.A2_runningCount ] ],
            visibilityChangeEventSources : [ ZaBulkProvision.A2_runningCount ]
        }, {
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.IdleMailboxes,
            ref : ZaBulkProvision.A2_idleCount,
            visibilityChecks : [ [ XForm.checkInstanceValueNotEmty, ZaBulkProvision.A2_idleCount ] ],
        ...
        {
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.FinishedMaiboxes,
            ref : ZaBulkProvision.A2_finishedCount,
            visibilityChecks : [ [ XForm.checkInstanceValueNotEmty, ZaBulkProvision.A2_finishedCount ] ],
            ...
            getDisplayValue : function(val) {
                return val == "1" ? ZaMsg.Yes : ZaMsg.No;
            }
        }, {
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.IMAPAdminLogin,
            ...
            style : DwtAlert.INFO,
            iconVisible : false,
            content : com_zimbra_bulkprovision.ClickNextToStartImport,
            visibilityChecks : []
        } ]
    };
    ...
    var case_finish = {
        ...
        numCols : 2,
        colSizes : [ "250px", "380px" ],
        tablGroupKey : ZaBulkDataImportXWizard.STEP_FINISH,
        caseKey : ZaBulkDataImportXWizard.STEP_FINISH,
        items : [ {
            type : _DWT_ALERT_,
            colSpan : 2,
            style : DwtAlert.INFO,
            iconVisible : false,
            content : com_zimbra_bulkprovision.DataImportStarted,
            visibilityChecks : []
        } ]
    };
