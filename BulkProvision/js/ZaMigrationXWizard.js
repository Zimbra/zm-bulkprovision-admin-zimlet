...
function ZaMigrationXWizard(parent, entry) {
    var w = "650px";
    ZaXWizardDialog.call(this, parent, null, com_zimbra_bulkprovision.BP_Exch_Mig_Wiz_Title, w, (AjxEnv.isIE ? "330px"
            : "320px"), "ZaMigrationXWizard");

    this.stepChoices = [ {
        label : com_zimbra_bulkprovision.MIG_Wizard_overview,
        value : ZaMigrationXWizard.STEP_INTRODUCTION
    }, {
        label : com_zimbra_bulkprovision.MIG_Wizard_migrationOptions,
        value : ZaMigrationXWizard.STEP_PROV_OPTIONS
    }, {
        label : com_zimbra_bulkprovision.MIG_Wizard_mailServerInfo,
        value : ZaMigrationXWizard.STEP_EXCHANGE_INFO
    }, {
        label : com_zimbra_bulkprovision.MIG_Wizard_ADOptions,
        value : ZaMigrationXWizard.STEP_LDAP_INFO
    }, {
        label : com_zimbra_bulkprovision.MIG_Wizard_review,
        value : ZaMigrationXWizard.STEP_REVIEW
    }, {
        label : com_zimbra_bulkprovision.BP_Wizard_download,
        value : ZaMigrationXWizard.STEP_DOWNLOAD_FILE
    } ];

    this.initForm(ZaBulkProvision.getMyXModel(), this.getMyXForm(entry), null);

    this._helpURL = [ location.pathname, ZaUtil.HELP_URL, ZaMigrationXWizard.helpURL, "?locid=", AjxEnv.DEFAULT_LOCALE ]
            .join("");
    ;
}
 ...
 * server callbacks
 */
ZaMigrationXWizard.prototype.generateBulkFileCallback = function(params, resp) {
    try {
...
ZaMigrationXWizard.prototype.previewCallback = function(params, resp) {
    try {
        ...
        if (ex.code == ZaBulkProvision.BP_INVALID_SEARCH_FILTER) {
            ...
            ZaApp.getInstance().getCurrentController()._handleException(ex,
                    "ZaMigrationXWizard.prototype.previewCallback");
        }
 ...
 * finish)
 */
ZaMigrationXWizard.prototype.popup = function(loc) {
...
ZaMigrationXWizard.prototype.goNext = function() {
    ...
    if (cStep == ZaMigrationXWizard.STEP_INTRODUCTION) {
        ...
        if (!this._containedObject[ZaBulkProvision.A2_TargetDomainName]) {
            ZaApp.getInstance().getCurrentController().popupErrorDialog(
                    com_zimbra_bulkprovision.MUST_SELECT_TARGET_DOMAIN);
            return;
        }
        ...
        if (!this._containedObject[ZaBulkProvision.A2_GalLdapSearchBase]
                && typeof this._containedObject[ZaBulkProvision.A2_TargetDomainName] == "string") {
            var searchBase = "cn=Users,dc="
                    + this._containedObject[ZaBulkProvision.A2_TargetDomainName].replace(".", ",dc=");
            this._localXForm.setInstanceValue(searchBase, ZaBulkProvision.A2_GalLdapSearchBase);
        }

        if (!this._containedObject[ZaBulkProvision.A2_GalLdapBindDn]
                && typeof this._containedObject[ZaBulkProvision.A2_TargetDomainName] == "string") {
            var bindDN = "cn=administrator,cn=Users,dc="
                    + this._containedObject[ZaBulkProvision.A2_TargetDomainName].replace(".", ",dc=");
        ...
        var callback = new AjxCallback(this, ZaMigrationXWizard.prototype.generateBulkFileCallback, {
 ...
 *                object to display
 */
ZaMigrationXWizard.prototype.setObject = function(entry) {
...
ZaMigrationXWizard.myXFormModifier = function(xFormObject, entry) {
    ...
    var case_introduction = {
        type : _CASE_,
        numCols : 1,
        tabGroupKey : ZaMigrationXWizard.STEP_INTRODUCTION,
        caseKey : ZaMigrationXWizard.STEP_INTRODUCTION,
        items : [ {
            type : _DWT_ALERT_,
            style : DwtAlert.INFO,
            iconVisible : false,
            content : com_zimbra_bulkprovision.ExchMigrationWizardIntro,
            visibilityChecks : [],
            enableDisableChecks : []
        } ]
    };
    ...
    var case_prov_options = {
        ...
        numCols : 2,
        colSizes : [ "250px", "*" ],
        tabGroupKey : ZaMigrationXWizard.STEP_PROV_OPTIONS,
        caseKey : ZaMigrationXWizard.STEP_PROV_OPTIONS,
        items : [ {
            type : _DWT_ALERT_,
            style : DwtAlert.INFO,
            iconVisible : false,
            ...
            ref : ZaBulkProvision.A2_provisionUsers,
            type : _WIZ_CHECKBOX_,
            label : com_zimbra_bulkprovision.A2_provisionUsers,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            ref : ZaBulkProvision.A2_importMails,
            type : _WIZ_CHECKBOX_,
            label : com_zimbra_bulkprovision.MigImportMails,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            ref : ZaBulkProvision.A2_importContacts,
            type : _WIZ_CHECKBOX_,
            label : com_zimbra_bulkprovision.MigImportContacts,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            ref : ZaBulkProvision.A2_importTasks,
            type : _WIZ_CHECKBOX_,
            label : com_zimbra_bulkprovision.MigImportTasks,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            ref : ZaBulkProvision.A2_importCalendar,
            type : _WIZ_CHECKBOX_,
            label : com_zimbra_bulkprovision.MigImportCalendar,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            ref : ZaBulkProvision.A2_importDeletedItems,
            type : _WIZ_CHECKBOX_,
            label : com_zimbra_bulkprovision.MigImportDeletedItems,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            ref : ZaBulkProvision.A2_importJunk,
            type : _WIZ_CHECKBOX_,
            label : com_zimbra_bulkprovision.MigImportJunk,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            ref : ZaBulkProvision.A2_ignorePreviouslyImported,
            type : _WIZ_CHECKBOX_,
            label : com_zimbra_bulkprovision.MigIgnorePreviouslyImported,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            ref : ZaBulkProvision.A2_InvalidSSLOk,
            type : _WIZ_CHECKBOX_,
            label : com_zimbra_bulkprovision.MigInvalidSSLOk,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : []
    ...
    var case_exchange_options = {
        ...
        numCols : 2,
        colSizes : [ "250px", "*" ],
        tabGroupKey : ZaMigrationXWizard.STEP_EXCHANGE_INFO,
        caseKey : ZaMigrationXWizard.STEP_EXCHANGE_INFO,
        items : [ {
            ref : ZaBulkProvision.A2_TargetDomainName,
            type : _TEXTFIELD_,
            ...
            style : DwtAlert.INFO,
            iconVisible : false,
            content : com_zimbra_bulkprovision.ZimbraAdminPasswordNote,
            visibilityChecks : [],
            enableDisableChecks : [],
            colSpan : 2
        }, {
            ref : ZaBulkProvision.A2_ZimbraAdminLogin,
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.A2_ZimbraAdminLogin,
            labelLocation : _LEFT_,
            enableDisableChecks : [],
            visibilityChecks : []
        }, {
            ref : ZaBulkProvision.A2_ZimbraAdminPassword,
            type : _SECRET_,
            label : com_zimbra_bulkprovision.A2_ZimbraAdminPassword,
            labelLocation : _LEFT_,
            enableDisableChecks : [],
            visibilityChecks : []
        }, {
            ref : ZaBulkProvision.A2_ZimbraAdminPasswordConfirm,
            type : _SECRET_,
            label : com_zimbra_bulkprovision.A2_ZimbraAdminPasswordConfirm,
            labelLocation : _LEFT_,
            enableDisableChecks : [],
            visibilityChecks : []
        }, {
            ...
            style : DwtAlert.INFO,
            iconVisible : false,
            content : com_zimbra_bulkprovision.MAPIINfoNote,
            visibilityChecks : [],
            enableDisableChecks : [],
            colSpan : 2
        }, {
            ref : ZaBulkProvision.A2_MapiProfile,
            type : _TEXTFIELD_,
            label : com_zimbra_bulkprovision.A2_MapiProfile,
            labelLocation : _LEFT_,
            enableDisableChecks : [],
            visibilityChecks : []
        }, {
            ref : ZaBulkProvision.A2_MapiServer,
            type : _TEXTFIELD_,
            label : com_zimbra_bulkprovision.A2_MapiServer,
            labelLocation : _LEFT_,
            enableDisableChecks : [],
            visibilityChecks : []
        }, {
            ref : ZaBulkProvision.A2_MapiLogonUserDN,
            type : _TEXTFIELD_,
            width : "380px",
            label : com_zimbra_bulkprovision.A2_MapiLogonUserDN,
            labelLocation : _LEFT_,
            enableDisableChecks : [],
            visibilityChecks : []
        }
    ...
    var case_ldap_info = {
        ...
        tabGroupKey : ZaMigrationXWizard.STEP_LDAP_INFO,
        caseKey : ZaMigrationXWizard.STEP_LDAP_INFO,
        items : [ {
            type : _DWT_ALERT_,
            style : DwtAlert.INFO,
            iconVisible : false,
            content : com_zimbra_bulkprovision.ADInfoStepNote,
            colSpan : 2
        }, {
            ...
            items : [ {
                ...
                label : null,
                labelLocation : _NONE_,
                value : com_zimbra_bulkprovision.ADServerName,
                width : "200px"
            }, {
                type : _OUTPUT_,
                label : null,
                ...
                label : null,
                labelLocation : _NONE_,
                value : com_zimbra_bulkprovision.ADServerPort,
                width : "40px"
            }, {
                type : _OUTPUT_,
                label : null,
                labelLocation : _NONE_,
                value : com_zimbra_bulkprovision.ADUseSSL,
                width : "*"
            } ]
        }, {
    ...
    var case_review = {
        ...
        items : [ {
            ...
            style : DwtAlert.INFO,
            iconVisible : false,
            content : com_zimbra_bulkprovision.ReviewStepNote,
            visibilityChecks : [],
            enableDisableChecks : []
        }, {
            type : _OUTPUT_,
            ...
            ref : ZaBulkProvision.A2_provisionUsers,
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.RevA2_provisionUsers,
            visibilityChecks : [],
            enableDisableChecks : [],
            getDisplayValue : function(val) {
                return val == "TRUE" ? ZaMsg.Yes : ZaMsg.No;
            ...
            ref : ZaBulkProvision.A2_importMails,
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.RevMigImportMails,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : [],
            ...
            ref : ZaBulkProvision.A2_importContacts,
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.RevMigImportContacts,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : [],
            ...
            ref : ZaBulkProvision.A2_importTasks,
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.RevMigImportTasks,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : [],
            ...
            ref : ZaBulkProvision.A2_importCalendar,
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.RevMigImportCalendar,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : [],
            ...
            ref : ZaBulkProvision.A2_importDeletedItems,
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.RevMigImportDeletedItems,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : [],
            ...
            ref : ZaBulkProvision.A2_importJunk,
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.RevMigImportJunk,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : [],
            ...
            ref : ZaBulkProvision.A2_ignorePreviouslyImported,
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.RevMigIgnorePreviouslyImported,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : [],
            ...
            ref : ZaBulkProvision.A2_InvalidSSLOk,
            type : _OUTPUT_,
            label : com_zimbra_bulkprovision.RevMigInvalidSSLOk,
            trueValue : "TRUE",
            falseValue : "FALSE",
            visibilityChecks : [],
            enableDisableChecks : [],
    ...
    var case_download_file = {
        ...
        numCols : 1,
        colSizes : [ "*" ],
        tabGroupKey : ZaMigrationXWizard.STEP_DOWNLOAD_FILE,
        caseKey : ZaMigrationXWizard.STEP_DOWNLOAD_FILE,
        items : [ {
            type : _DWT_ALERT_,
            style : DwtAlert.INFO,
            iconVisible : false,
            content : com_zimbra_bulkprovision.ClickToDownloadGeneratedFile
        }, {
            type : _DATA_URL_,
            labelLocation : _NONE_,
            label : com_zimbra_bulkprovision.DownloadMigrationXML,
            ref : ZaBulkProvision.A2_generatedFileLink
        }, {
            type : _ANCHOR_,
            labelLocation : _NONE_,
            label : com_zimbra_bulkprovision.DownloadMigrationWizard,
            href : ZaMsg.MIG_WIZ_DOWNLOAD_LINK
        } ]
    };
